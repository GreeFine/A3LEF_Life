...
switch (_className) do
{
	...
	case "A3L_VolksWagenGolfGTired": {65};
	case "A3L_VolksWagenGolfGTiblack": {65};
	case "A3L_VolksWagenGolfGTiblue": {65};
    case "A3L_VolksWagenGolfGTiwhite": {65};
	...
	case "A3L_F350Black": {200};
	case "A3L_F350Blue": {200};
	case "A3L_F350Red": {200};
	case "A3L_F350White": {200};
	case "A3L_Dumptruck": {600};

	case "IVORY_T6A_1": {50};
	case "bwi_a3_t6a_6": {50};
	case "bwi_a3_t6a_nta": {50};
	case "bwi_a3_t6a_7": {50};
	case "bwi_a3_t6a_9": {50};
	case "bwi_a3_t6a_4": {50};
    case "C_Heli_Light_01_civil_F": {50};
    case "ivory_b206": {200};
    case "ivory_b206_news": {100};
    case "IVORY_BELL512": {550};
